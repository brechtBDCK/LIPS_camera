...
ONI_C_API OniStatus oniDeviceEnableDepthIRSync(OniDeviceHandle device);
ONI_C_API void oniDeviceDisableDepthIRSync(OniDeviceHandle device);
ONI_C_API OniBool oniDeviceGetDepthIRSyncEnabled(OniDeviceHandle device);
